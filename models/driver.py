...
class Driver:
    ...
    # Use an overload to intialize based on the driver type input
    def __init__(self, driver):
        if type(driver) == dict:
            ...
            self.potentialRetain = driver['potentialRetain']
        else:
            self.name = driver[0]
            self.age = driver[1]
            ...
            self.potentialRetain = driver[12]
    ...
    def printInfo(self):
        print("\nDriver Name:", self.name,
            ...
            "\nPotential Retain:", self.potentialRetain, "\n")
